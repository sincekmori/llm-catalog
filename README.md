...
It is the Python counterpart of [`ai-sdk-catalog`](https://github.com/sincekmori/ai-sdk-utils) (Vercel AI SDK), reading the **same config file**: one `ai-sdk-catalog.json` drives TypeScript and Python alike (schema parity with ai-sdk-catalog 0.8).
...
The config format is **JSON**, shared verbatim with `ai-sdk-catalog` (0.8) — write one file and hand it to both runtimes.
