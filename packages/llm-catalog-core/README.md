...
It holds the config schema (shipped as `schema.json` for editor validation; parity with `ai-sdk-catalog` 0.7), validation, role resolution, the path-rewriting `GatewayTransport`, and native LiteLLM codegen.
